...
import {
  ...
  DeleteEmployeeAttribute,
  EditEmployeeAttributes,
...
const EmployeeAttributes = () => {
  ...
  const handleSubmitForm = async (data) => {
    ...
    try {
      const response = await dispatch(
        AddEmployeeAttributes(
          { attributeKey: formattedAttributeKey },
          AccessToken
        )
      );
      console.log(response);
  ...
  const handleSaveEdit = async (editedAttributeValue, id) => {
    ...
    try {
      const response = await dispatch(
        EditEmployeeAttributes(
          { attributeKey: formattedAttributeValue },
          id,
          AccessToken
        )
      );
      ...
      <div className="container mx-auto mt-8">
        ...
        >
          <div className="mb-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                className={`flex-none h-full text-sm md:text-base font-medium rounded-md py-2 px-5 ${
                  ...
                  {editAttributeId === attr.attributeId ? (
                    <>
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleSaveEdit(editAttributeValue, attr.attributeId)
                        }
          ...
          <button
            ...
            className={`w-full text-sm md:text-base font-medium rounded-md py-2 px-5 ${
              darkMode ? "bg-blue-500" : "bg-blue-700"
            } ${
              darkMode ? "text-white" : "text-white"
            } hover:scale-95 transition-all duration-200`}
